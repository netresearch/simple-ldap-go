...
## Tech Stack
- **Language**: Go 1.26.0+ (toolchain go1.27.1); built and unit-tested on 1.26 and 1.27
- **Main Dependency**: github.com/go-ldap/ldap/v3 v3.4.14
- **Text Processing**: golang.org/x/text v0.42.0
